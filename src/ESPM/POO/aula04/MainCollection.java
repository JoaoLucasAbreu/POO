...
public class MainCollection {
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> sinteiros = new TreeSet<Integer>();// Não suporta números repetidos
        sinteiros.add(1);
        sinteiros.add(2);
        sinteiros.add(3);
        sinteiros.add(1);
        ...
        List<Integer> linteiros = new ArrayList<>();// Suporta números repetidos
        linteiros.add(1);
        linteiros.add(2);
        linteiros.add(3);
        linteiros.add(1);
        ...
        List<Aluno> lalunos = new ArrayList<>();// Suporta números repetidos
